...
function addInput(e, tabName) {
	...
	switch (tabName) {
		case 'contactsTableBody':
			innerText+=`<tr>
							<td><input name="contacts_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'educationTableBody':
			innerText+=`<tr>
							<td><input name="education_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'armyTableBody':
			innerText+=`<tr>
							<td><input name="army_ids[]" placeholder="ID" class="login-input-label" disabled></td>
							<td><input name="army_suitablility[]" placeholder="Suitability" class="login-input-label"></td>
		...
		case 'workTableBody':
			innerText+=`<tr>
							<td><input name="work_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'relationshipTableBody':
			innerText+=`<tr>
							<td><input name="relationship_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'skillsTableBody':
			innerText+=`<tr>
							<td><input name="skills_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'languagesTableBody':
			innerText+=`<tr>
							<td><input name="languages_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'likesTableBody':
			innerText+=`<tr>
							<td><input name="likes_ids[]" placeholder="ID" class="login-input-label" disabled></td>
		...
		case 'propertyTableBody':
			innerText+=`<tr>
							<td><input name="property_ids[]" placeholder="ID" class="login-input-label" disabled></td>
